...
// System.out.println("EndPoint: " + option.getEndPoint() + ", KvEndPoint: " +
// option.getKvEndPoint()
// + ", ReplicaCount: " + option.getReplicaCount());
// Client client =
// Client.builder().endpoint(option.getEndPoint()).kvEndpoint(option.getKvEndPoint()).build();
// while (true) {
...
// Thread consumerThread = new Thread(new Consumer(crcQueue, producerThread,
// stream));
...
// public Consumer(BlockingQueue<Elem> crcQueue, Thread producerThread, Stream
// stream) {
// this.crcQueue = crcQueue;
