...
public class MetadataTest {
    ...
    public static void main(String[] args) {
        ...
        // assertEquals(false, openStream(client, 0));
        // assertEquals(false, openStream(client, Long.MAX_VALUE));
        ...
        // for (long i = option.getCount(); i < option.getCount() + 100; i++) {
        // assertEquals(false, openStream(client, i));
        // }
